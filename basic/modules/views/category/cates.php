                    ...
                    <?php foreach($cates as $cate): ?>
                        <tr class="first">
                            ...
                            <td class="align-right">
                                <a href="<?php echo yii\helpers\Url::to(['category/mod', 'category_id' => $cate['category_id']]); ?>">编辑</a>
                                <a href="<?php echo yii\helpers\Url::to(['category/del', 'category_id' => $cate['category_id']]); ?>">删除</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
