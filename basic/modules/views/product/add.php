            ...
            <div class="row-fluid form-wrapper">
                ...
                <div class="span9 with-sidebar">
                    <div class="container">
                        ...
                        echo $form->field($model, 'category_id')->dropDownList($opts, ['id' => 'cates']);
                        ...
                        echo $form->field($model, 'sales_price')->textInput(['class' => 'span9']);
                        ...
                        foreach((array)json_decode($model->pics, true) as $k=>$pic) {
                            ...
                            <a href="<?php echo yii\helpers\Url::to(['product/removepic', 'key' => $k, 'product_id' => $model->product_id]) ?>">删除</a>
                            <?php
                        }
                        ?>
                        <hr>
